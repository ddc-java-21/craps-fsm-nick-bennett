...
public class Main {
  ...
  private static final String TALLY_FORMAT =
      "Rounds = %1$,d; wins = %2$,d; winning percentage = %3$.2f%%%n";
  ...
  public static void main(String[] args) {
    ...
    for (int rounds = 0; rounds < MAX_ROUNDS; rounds++) {
      if (rounds > 0 && rounds % TALLY_INTERVAL == 0) {
        System.out.printf(TALLY_FORMAT, rounds, wins, PERCENTAGE_SCALE * wins / rounds);
      }
